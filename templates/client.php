...
<head>
    ...
    <link href="<?= htmlspecialchars($cssUrl, ENT_QUOTES, 'UTF-8') ?>?v=1.5.1" rel="stylesheet">
</head>
<body id="game-app" class="is-client">
...
<?php $activeNav = 'client'; require __DIR__ . '/partials/header_nav.php'; ?>
        <div class="global-actions">
            <span id="sessionStateBadge" class="badge-retro">READY</span>
        </div>
    </header>

    <div class="editor-workspace editor-workspace--split" style="position: relative; z-index: 1;">
        <!-- Client Character Selection UI (Overlay) -->
        <div id="client-ui-overlay" class="client-ui-overlay d-flex justify-content-center align-items-center" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: var(--bg-darkest); z-index: 9999;">
            <div id="client-root" style="width: 100%; max-width: 800px; background: var(--bg-dark); padding: 20px; border-radius: 8px; border: 1px solid var(--border-color);">
                <!-- Rendered by JS -->
            </div>
        </div>
        ...
        <aside class="am-sidebar game-sidebar">
            <div class="am-sidebar-body">
                ...
                <div class="am-sidebar-section" style="display: none !important;">
            ...
            <div class="game-sidebar-footer">
                ...
                <button type="button" class="btn btn-retro btn-danger w-100 mb-1" id="logOutBtn" title="Log out and return to character selection">
            ...
            <div class="game-canvas-wrap canvas-container action-bars-layout" id="gameCanvasContainer">
                ...
                <div class="canvas-middle-row">
                    ...
                    <div class="canvas-center-wrapper" id="canvasCenterWrapper">
                        ...
                        <canvas id="gameCanvas" width="720" height="480" tabindex="-1" aria-label="Hunt view"></canvas>
                    </div>
