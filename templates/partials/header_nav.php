...
?>
        <nav class="<?= htmlspecialchars($navClass, ENT_QUOTES, 'UTF-8') ?>">
            ...
            <div class="menu-dropdown<?= $is('wiki-creatures', 'wiki-equipment', 'wiki-spells', 'wiki-legacy-map') ?>">
                <span class="menu-item menu-dropdown-trigger<?= $is('wiki-creatures', 'wiki-equipment', 'wiki-spells', 'wiki-legacy-map') ?>" role="button" tabindex="0" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="menu-dropdown-panel" role="menu">
                    ...
                    <a class="menu-dropdown-item<?= $is('wiki-spells') ?>" role="menuitem"
                       href="<?= htmlspecialchars($asset('wiki-spells.php'), ENT_QUOTES, 'UTF-8') ?>">Spells</a>
