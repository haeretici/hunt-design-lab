<?php
/**
 * Scenario Lab page template — select fixture, tweak vars, watch combat.
 * Expects $appRoot (web path to project root, usually '') and optional $pageTitle.
 */

declare(strict_types=1);

$pageTitle = $pageTitle ?? 'Scenario Lab — Hunt Design Lab';
...
<?php $activeNav = 'scenario-lab'; require __DIR__ . '/partials/header_nav.php'; ?>
    ...
    <div class="editor-workspace editor-workspace--split">
        <aside class="am-sidebar game-sidebar">
            <div class="am-sidebar-body">
                ...
                <div class="am-sidebar-section">
                    <h2 class="am-sidebar-title">Scenario</h2>
                    ...
                    <label class="label-retro" for="scenarioSelect">Test situation</label>
                    <select class="form-select form-select-retro w-100 mb-1" id="scenarioSelect"></select>
                    <p class="text-muted text-xxs mb-2" id="scenarioDescription"></p>

                    <label class="label-retro" for="partySelect">Party</label>
                    <select class="form-select form-select-retro w-100 mb-2" id="partySelect" title="Override fixture party with a party preset"></select>

                    <label class="label-retro" for="seedInput">Seed</label>
                    <input type="number" class="form-control form-control-retro w-100 mb-2" id="seedInput" value="1" min="1" step="1">
                    ...
                    <p class="text-muted text-xxs mb-0">No scrubber — fixtures start at the forced setup each run.</p>
                </div>

                <div class="am-sidebar-section">
                    <h2 class="am-sidebar-title">Variables</h2>
                    <div id="scenarioSettingsKnobs"></div>
                </div>

                <div class="am-sidebar-section">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <h2 class="am-sidebar-title mb-0">Party members</h2>
                        <button type="button" class="btn btn-retro btn-retro-cyan btn-sm" id="resetPartyBtn" title="Reload members from selected party">
                            Reset
                        </button>
                    </div>
                    <p class="text-muted text-xxs mb-1">Enable/disable slots, pick a leader, and Set Active for the camera view (defaults to leader).</p>
                    <div id="partySlots" class="party-slots"></div>
                    <div id="scenarioPartySummary" class="live-member-list mt-2" hidden>
            ...
            <div class="game-sidebar-footer">
                ...
                <span class="d-block text-muted game-popup-hint">AI debug overlays live in the popup</span>
            </div>
        </aside>
        ...
        <main class="game-main">
            ...
            <div class="game-below-canvas">
                <section class="game-live-section" aria-label="Live scenario telemetry">
                    <div class="am-sidebar-title-row">
                        <h2 class="am-sidebar-title mb-0">Live scenario</h2>
                    ...
                    <p class="text-muted small mb-0 game-live-hint">
                        Pick a fixture (choke pack, leash, wipe), tweak seed / Settings knobs,
                        watch combat. Headless: <code>npm run test:scenarios</code> /
                        <code>runScenarioHunt</code>. Full corridor hunts stay on Hunt Simulator.
                    </p>
                </section>
            </div>
        </main>
        ...
        <aside class="game-inventory-panel" aria-label="Equipment and backpack">
            <div class="am-sidebar-body">
                ...
                <section class="game-backpack-panel panel-collapsible-section" data-panel-id="backpack" aria-label="Backpack inventory">
                    <div class="am-sidebar-title-row panel-toggle-header" role="button" tabindex="0" title="Click to collapse or expand">
                    ...
                    <div class="panel-collapsible-content">
                        <div class="backpack-grid-scroll" id="backpackScroll">
                ...
                <section class="game-combat-panel panel-collapsible-section" data-panel-id="combat" aria-label="Combat enemies list">
                    <div class="am-sidebar-title-row">
                        <div class="panel-toggle-header d-flex align-items-center flex-grow-1" role="button" tabindex="0" title="Click to collapse or expand">
                            <div class="d-flex align-items-center gap-1">
                                <i class="fa-solid fa-chevron-down panel-toggle-icon"></i>
                        ...
                        <div class="combat-sort-container">
                            <button type="button" class="btn btn-sm btn-outline-secondary party-details-btn" id="combatSortBtn" title="Sort by: Display Time - ASC (Default)" aria-label="Sort options">
                    ...
                    <div class="panel-collapsible-content">
                        <div class="entity-panel-list-scroll">
